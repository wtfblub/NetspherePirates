...
//        private static readonly TimeSpan _nextChaserWaitTime = TimeSpan.FromSeconds(10);
...
//                    return;
//                _bonus = value;
//                if (Room.GameStateManager.State == GameState.Playing)
...
//        {
//            Room.GameStateManager.HasHalfTime = false;
...
//            var stateMgr = Room.GameStateManager;
...
//                if (_nextChaserTimer >= _nextChaserWaitTime)
//                    NextChaser();
//            }
//            else
//            {
...
//                {
//                    var diff = Room.Options.TimeLimit - Room.GameStateManager.RoundTime;
//                    if (diff >= (_chaserRoundTime + _nextChaserWaitTime))
//                        ChaserLose();
//                }

//                if (Chaser.RoomInfo.State == PlayerState.Dead)
//                {
//                    ChaserLose();
//                }
//                else if (!teamMgr.Values.Any(team => team.Values.Any(plr =>
//                                    plr != Chaser &&
...
//            {
//                Room.Master.Session.Send(new SEventMessageAckMessage(GameEventMessage.CantStartGame, 0, 0, 0, ""));
//                return;
//            }

//            base.BeginRound();

//            // ToDo Do this with an StateChanged event
//            if (Room.GameStateManager.State == GameState.Playing)
//            {
...
//                Room.Broadcast(new SEventMessageAckMessage(GameEventMessage.ChaserIn, (ulong)_nextChaserWaitTime.TotalMilliseconds, 0, 0, ""));
//                return;
//            }
